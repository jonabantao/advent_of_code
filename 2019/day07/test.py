...
class TestDay07(unittest.TestCase):
    def setUp(self):
        self.solution = day07.Solution()

    def test_01(self):
        program = [3, 15, 3, 16, 1002, 16, 10,
                   16, 1, 16, 15, 15, 4, 15, 99, 0, 0]
        phase_seq = [4, 3, 2, 1, 0]
        expected = 43210
        self.assertEqual(
            expected, self.solution.compute_thruster_signal(program, phase_seq))
    ...
    def test_05(self):
        program = [3, 52, 1001, 52, -5, 52, 3, 53, 1, 52, 56, 54, 1007, 54, 5, 55, 1005, 55, 26, 1001, 54, -5, 54, 1105, 1, 12, 1,
